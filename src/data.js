...
export const DATA = {
  ...
  speakers: [
    ...
    },
    {
      ...
      name: 'Laís Preisler',
      role: '',
      topic: 'Estratégia, marketing e posicionamento para arquitetos',
    ...
    {
      revealed: true,
      name: 'Terraço Paisagismo',
      role: '',
      topic: 'Fazer Menos, Fazer Melhor. Posicionamento e a construção de uma identidade de escritório',
      instagram: '@terracopaisagismo',
      tag: 'Palestra',
      photo: '/assets/palestrantes/terraco-paisagismo.jpg',
      photoPosition: '50% 40%',
    },
    {
      revealed: true,
      name: 'Doppio',
      role: '',
      topic: 'Como conseguir clientes na arquitetura',
      instagram: '@doppioconsult',
      tag: 'Palestra',
      photo: '/assets/palestrantes/doppio.jpg',
      photoPosition: '50% 30%',
    },
    {
      revealed: true,
    ...
    {
      revealed: true,
      name: 'Amanda Pamato Branco',
      role: '',
      topic: 'Antes do Traço: Uma leitura contemporânea | Contextualização Hackaton',
      instagram: '@unio.arqeng',
      tag: 'Palestra',
      photo: '/assets/palestrantes/amanda-pamato-branco.jpg',
      photoPosition: '50% 30%',
    },
  ...
  schedule: [
    {
      ...
      items: [
        { t: '13h50', title: 'Abertura', kind: 'evento' },
    ...
    },
    {
      ...
      items: [
        ...
        { t: '10h30', title: 'Contextualização | Dorvalino Pedro de Mello Filho', kind: 'hackathon', track: 0 },
        { t: '11h', title: 'Terraço Paisagismo', kind: 'palestra', track: 1 },
        { t: '11h30', title: 'Amanda Pamato Branco', kind: 'palestra', track: 0 },
